...
(function() {
    ...
    function() {
        ...
        e = new Instafeed({
            get: "tagged",
            tagName: "cavecrush",
            clientId: "93b44acbb7ff4f509a3ed24af5b56150",
            accessToken: '2018937247.1677ed0.7f0161d4a16444c1be6673994ea3bbea',
            resolution: "standard_resolution",
            template: ' <div id="{{id}}" class="instagram_container">        <div id="{{id}}">          <a href="{{link}}" target="_blank" title="{{caption}} by @{{model.user.username}}" >            <img src="{{image}}" alt="{{caption}} by @{{model.user.username}}" class="instagram_image" />          </a>    </div>     </div>   '
        }), e.run()
    }.call(this);